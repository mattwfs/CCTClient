...
<div class="main-content pad">
    <div class="container">
        ...
        <p>When accessing the <a href="https://conductclinicaltrials.com/" target="_blank">https://conductclinicaltrials.<wbr>com/</a> website, <i>Conduct Clinical Trials</i> will learn certain
        ...
        <p><i>Conduct Clinical Trials</i> will not obtain personally-identifying information about you when you visit our
            site,
        ...
        <p>We will use your e-mail address solely to provide timely information about <i>Conduct Clinical Trials</i>.</p>
        ...
        <p><a href="https://conductclinicaltrials.com" target="_blank">https://conductclinicaltrials.<wbr>com</a> may contain links to many other websites. <i>Conduct Clinical Trials</i> cannot
            guarantee
            the accuracy of information found at any linked site. Links to or from external sites not owned or controlled
            by <i>Conduct Clinical Trials</i> do not constitute an endorsement by <i>Conduct Clinical Trials</i> or any of its employees of
        ...
        <p>All copyrights, trademarks, patents and other intellectual property rights in and on our website and all content and
            software located on the site shall remain the sole property of <i>Conduct Clinical Trials</i> or its licensors.
            The use
            of our trademarks, content and intellectual property is forbidden without the express written consent
            from <i>Conduct Clinical Trials</i>.</p>
        ...
        <p><i>Conduct Clinical Trials</i> is not responsible for any of the opinions or comments posted
            on <a href="https://conductclinicaltrials.com" target="_blank">https://conductclinicaltrials.<wbr>com</a>. <i>Conduct Clinical Trials</i> is not a forum for testimonials, however provides testimonials as a means for
            customers to share their experiences with one another. To protect against abuse, all testimonials appear after they
            have been reviewed by management of <i>Conduct Clinical Trials</i>. <i>Conduct Clinical Trials</i> doe not
            share the
            opinions, views or commentary of any testimonials on <a href="https://conductclinicaltrials.com" target="_blank">https://conductclinicaltrials.<wbr>com</a> - the opinions are strictly
            the
        ...
        <p><i>Conduct Clinical Trials</i> may use software programs to create summary statistics, which are used for such
            purposes
        ...
        <p>For site security purposes and to ensure that this service remains available to all
            users, <i>Conduct Clinical Trials</i>	uses software programs to monitor network traffic to identify unauthorized attempts to upload or change
            information, or otherwise cause damage.</p>

        <h3>Disclaimer and Limitation of Liability</h3>

        <p><i>Conduct Clinical Trials</i> makes no representations, warranties, or assurances as to the accuracy, currency or
        ...
        <p>All the materials on this site are provided "as is" without any express or implied warranty of any kind, including
            ...
            event shall <i>Conduct Clinical Trials</i> or its agents or associates be liable for any damages whatsoever
            (including,
            without limitation, damages for loss of profits, business interruption, loss of information, injury or death)
            arising out of the use of or inability to use the materials, even if <i>Conduct Clinical Trials</i> has been
            advised of
        ...
        <p>If you have any questions regarding this policy, or your dealings with our website, please contact us
            here: <a href="https://conductclinicaltrials.com/" target="_blank">https://conductclinicaltrials.<wbr>com/</a></p>

        <p><i>Conduct Clinical Trials</i><br>
            4533 MacArthur Blvd.<br>
            Newport Beach, CA 92660</p><span style="margin: 0px auto; border: 2px dotted rgb(255, 165, 0); position: absolute; z-index: 2147483647; visibility: hidden; left: 301px; width: 0px; top: 415px; height: 0px;"></span><span style="z-index: 2147483647; position: absolute; visibility: hidden; left: 286px; width: 50px; top: 400px; height: 20px; font-size: 10px; color: black;"></span>
    </div>
</div>
<!--end #main-content-->
