...
<div class="col-md-12">
        <div class="panel panel-info">
                <div class="panel-heading">Open Trials - {{count($trials)}} - <a href="{{ url('user/closed-trials')}}">Click here to view Closed Trials</a>
...
<script type="text/javascript">
    $("#specialization-filter").on('change',function(){
        if($(this).val()==0){
            window.location.href = "{{ url('user/open-trials')}}";
        } else {
